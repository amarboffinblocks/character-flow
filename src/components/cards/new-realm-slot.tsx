...
interface NewRealmSlotProps {
  onClick?: () => void;
}

export function NewRealmSlot({ onClick }: NewRealmSlotProps) {
  ...
  return (
    ...
    >
      <div className="relative w-[288px] transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)]" style={{ perspective: "1200px" }}>
        <div
        ...
        >
          <p className="text-sm text-white/50 font-mono text-center leading-5">
            {displayedText}
            {isHovered && (
              <span
        ...
        >
          ...
          <div className="relative h-[48px]">
            <div className="absolute inset-x-0 top-0 h-px border-t border-dashed border-white/4" />
